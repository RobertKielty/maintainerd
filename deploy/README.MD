...
graph RL
    subgraph maintainerd["Namespace: maintainerd"]
        ...
        job["Job: maintainerd-bootstrap<br/>Seeds data from CNCF Google Sheet"]
        pg[(Managed Postgres)]
    ...
    job -->|"SQL INSERTs into PROJECT and MAINTAINERS tables"| pg
```
...
TEXT name
    ...
    remote_teams {
        ...
        INTEGER remote_team_id
        TEXT remote_team_name
        TEXT project_name
    }
    ...
    remote_team_users {
        ...
        DATETIME deleted_at
        INTEGER service_id       "FK to services.id"
        INTEGER user_id          "FK to remote_users.id"
        INTEGER team_id          "FK to remote_teams.id"
    ...
    remote_teams          ||--o{ remote_team_users    : has
    services              ||--o{ remote_users         : has
```



## bootstrap job
 - bootstrap process loads project and maintainer data into Postgres from 
