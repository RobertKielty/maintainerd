...
const formatMetadataScalar = (value: unknown) => {
...
const getRecordArrayColumns = (rows: MetadataObject[]) => {
...
const getProjectHref = (row: MetadataObject) => {
...
const metadataProjectName = (entry: AuditLog) => {
...
const metadataMaintainerName = (entry: AuditLog) => {
  const parsed = parseMetadata(entry.metadata);
  if (!isMetadataObject(parsed)) {
    return "";
  }
...
const renderMetadataValue = (key: string, value: unknown, row: MetadataObject) => {
...
export default function AuditPage() {
  ...
  const renderTargets = (entry: AuditLog) => {
