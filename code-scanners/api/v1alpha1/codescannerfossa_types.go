...
type CodeScannerFossaSpec struct {
	...
	// foo is an example field of CodeScannerFossa. Edit codescannerfossa_types.go to remove/update
	// +optional
...
type CodeScannerFossaStatus struct {
	...
	// conditions represent the current state of the CodeScannerFossa resource.
